<html>
	...
	<body>
		...
		<?php
			...
			$sql="SELECT dni from emple_depart where cod_dpto='$codigo_dep' AND NOT fecha_fin='0000-00-00 00:00:00'";
			...
			if(count($dnis)==0){
				echo 'El Departamento no tiene historico';
			}else{
				echo "<h3>Departamento de ".$departamento."</h3><ul>";
				foreach($dnis as $dni){
					$select_value="select * from empleado inner join emple_depart on empleado.dni=emple_depart.dni where cod_dpto='$codigo_dep';";
					...
					echo "<li>".$nombre." ".$apellidos." de ".$inicio." a ".$fin."</li>";
				}
				echo "</ul>";
			}	
		}
